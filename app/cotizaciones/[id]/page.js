    ...
    try {
      ...
      for (let index = 0; index < items.length; index++) {
        ...
        if (item.productos?.description) {
          ...
          const descText = item.productos.description.substring(0, 250)
        ...
        doc.text(`$${item.precio_unitario?.toLocaleString('es-CO')}`, 165, yPos + 5, { align: 'right' })
        doc.setFont('helvetica', 'bold')
        doc.text(`$${item.subtotal?.toLocaleString('es-CO')}`, 185, yPos + 5, { align: 'right' })
      ...
      doc.text('* Precios incluyen IVA', 120, yPos)
      doc.setTextColor(...textColor)
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        doc.text('📍 Calle 14 # 5-44 Local 1 Centro, Santa Marta', 105, 275, { align: 'center' })
        doc.text('📱 WhatsApp: 573104130068', 105, 280, { align: 'center' })
    ...
    <>
      ...
      <div ref={printRef} style={{ display: 'none', width: '900px', padding: '40px', backgroundColor: 'white', fontFamily: 'Arial, sans-serif' }}>
                  ...
                  <td style={{ padding: '12px', borderBottom: '1px solid #eee' }}>
                    ...
                    {item.productos?.description && (
                      <div style={{ fontSize: '10px', color: '#555', lineHeight: '1.5', maxWidth: '450px' }}>
                        {item.productos.description.substring(0, 200)}...
                      </div>
                    )}
                  </td>
        ...
        <div style={{ marginLeft: 'auto', width: '400px', backgroundColor: '#f9fafb', padding: '25px', borderRadius: '8px', marginBottom: '30px' }}>
          ...
          <div style={{ fontSize: '11px', color: '#666', fontStyle: 'italic', marginTop: '12px' }}>
        ...
        {/* Información de contacto del local */}
        <div style={{ backgroundColor: '#f9fafb', padding: '20px', borderRadius: '8px', textAlign: 'center', marginTop: '30px' }}>
          <div style={{ fontSize: '14px', color: '#333', lineHeight: '1.8' }}>
            <p style={{ margin: '5px 0', fontWeight: 'bold' }}>📍 Calle 14 # 5-44 Local 1 Centro, Santa Marta</p>
            <p style={{ margin: '5px 0', fontWeight: 'bold' }}>📱 WhatsApp: 573104130068</p>
          </div>
        </div>
